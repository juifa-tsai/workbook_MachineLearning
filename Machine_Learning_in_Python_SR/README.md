...
The models of machine learning intruduced in this workbooks are included  **classification** and **regession** cases, and **supervisied** and **unsupervised** learners. On the other hand, following the books includes simple examples about data structure for anaylsis with some common tool which can be done in **Pyhton**. In the end, **Nature Language** and **Nueal network** are also provided.
